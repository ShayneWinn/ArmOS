...
{
    /// <summary>
    /// The ActivateMotorsCommand command.
    /// </summary>
    public class ActivateMotorsCommand : BaseModuleCommand
    {
        /// <summary>
        ...
        /// </summary>
        public override string Name => "motors/start";
        ...
        public ActivateMotorsCommand(ActiveMotorModule module)
        {
            Module = module;
        }
