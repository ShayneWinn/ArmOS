...
{
    /// <summary>
    /// The AddMotorsCommand command.
    /// </summary>
    public class AddMotorsCommand : BaseModuleCommand
    {
        /// <summary>
        ...
        /// </summary>
        public override string Name => "motors/add";
        ...
        public AddMotorsCommand(ActiveMotorModule module)
        {
            Module = module;
        }
