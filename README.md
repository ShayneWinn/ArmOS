...
Mother is a framework that enables Space Engineers players to build programmable block scripts.  Building custom scripts on top of [Mother Core](https://lukejamesmorrison.github.io/mother-docs/) is designed to be simple and intutive for both new and expert script developers.  It simplifies intergrid communication, navigation, block automation, and event monitoring. Should players chose, they can use Mother Core to run most automations on their grid without the need for an Event Controller or Timer Block.

Check out Mother's rich [documentation](https://lukejamesmorrison.github.io/mother-docs/) to see what she can do!
...
Like most Space Engineers scripts, Mother requires [MDK2](https://github.com/malforge/mdk2) to enable a rich development experience. A big thanks to **Malware** for their incredible contributions to the Space Engineers community.
